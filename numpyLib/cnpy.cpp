...
//
//--------------------------------------------------------------------------
size_t cnpy::getIndex(std::vector<size_t>& dims, std::vector<size_t>& indices)
{
    size_t n_dims = indices.size();
    size_t ind = 0;
    std::vector<size_t> strides(n_dims);
    strides[n_dims - 1] = 1;
...
//
//--------------------------------------------------------------------------
void cnpy::printDims(cnpy::NpyArray& arr)
{
    std::cout << "[";
